...
<div align="center">
  <a href="https://github.com/TatianaKarpovaP/Portfolio_Data_Analyst/blob/main/Figures/CV_Tatiana_Karpova_Data_Analyst.pdf" style="display:block;padding:10px 20px;background-color:#007bff;color:#fff;text-decoration:none;border-radius:5px; margin: 10px auto;">Let's get to know each other better - My CV</a>
